import{V as u}from"./VPagination.38bf057c.js";import{k as m,o as g,c as v,p as e,q as p,D as d,b as P,L as U,w as s,m as l,E as o}from"./index.b54d9fca.js";import{_ as z}from"./AppCardCode.a6b8276f.js";import{a as f,V as S}from"./VRow.64033f9e.js";import"./router.2f5148f2.js";import"./VBtn.a4aae81b.js";import"./position.e1a9cf7b.js";import"./vue.runtime.esm-bundler.e4fa70f7.js";import"./index.fb967781.js";import"./VCard.22430b76.js";import"./VAvatar.76efe2b9.js";import"./VImg.fa9bd3c1.js";import"./VDivider.aab4e4c1.js";const C={class:"d-flex flex-column gap-6"},$={__name:"DemoPaginationSize",setup(_){const t=m(1),r=m(2),n=m(3);return(a,i)=>(g(),v("div",C,[e(u,{modelValue:p(t),"onUpdate:modelValue":i[0]||(i[0]=c=>d(t)?t.value=c:null),length:7,size:"small"},null,8,["modelValue"]),e(u,{modelValue:p(r),"onUpdate:modelValue":i[1]||(i[1]=c=>d(r)?r.value=c:null),length:7},null,8,["modelValue"]),e(u,{modelValue:p(n),"onUpdate:modelValue":i[2]||(i[2]=c=>d(n)?n.value=c:null),length:7,size:"large"},null,8,["modelValue"])]))}},w={class:"d-flex flex-column gap-6"},j={__name:"DemoPaginationColor",setup(_){const t=m(1),r=m(2),n=m(3);return(a,i)=>(g(),v("div",w,[e(u,{modelValue:p(t),"onUpdate:modelValue":i[0]||(i[0]=c=>d(t)?t.value=c:null),length:7,"active-color":"success"},null,8,["modelValue"]),e(u,{modelValue:p(r),"onUpdate:modelValue":i[1]||(i[1]=c=>d(r)?r.value=c:null),length:7,"active-color":"error"},null,8,["modelValue"]),e(u,{modelValue:p(n),"onUpdate:modelValue":i[2]||(i[2]=c=>d(n)?n.value=c:null),length:7,"active-color":"info"},null,8,["modelValue"])]))}},I={__name:"DemoPaginationTotalVisible",setup(_){const t=m(1);return(r,n)=>(g(),P(u,{modelValue:p(t),"onUpdate:modelValue":n[0]||(n[0]=a=>d(t)?t.value=a:null),length:15,"total-visible":7},null,8,["modelValue"]))}},B={__name:"DemoPaginationLength",setup(_){const t=m(1);return(r,n)=>(g(),P(u,{modelValue:p(t),"onUpdate:modelValue":n[0]||(n[0]=a=>d(t)?t.value=a:null),length:15},null,8,["modelValue"]))}},E={__name:"DemoPaginationIcons",setup(_){const t=m(1);return(r,n)=>(g(),P(u,{modelValue:p(t),"onUpdate:modelValue":n[0]||(n[0]=a=>d(t)?t.value=a:null),length:5,"prev-icon":"mdi-menu-left","next-icon":"mdi-menu-right"},null,8,["modelValue"]))}},T={};function y(_,t){return g(),P(u,{length:5,disabled:""})}const k=U(T,[["render",y]]),L={__name:"DemoPaginationCircle",setup(_){const t=m(1);return(r,n)=>(g(),P(u,{modelValue:p(t),"onUpdate:modelValue":n[0]||(n[0]=a=>d(t)?t.value=a:null),length:5,rounded:"circle"},null,8,["modelValue"]))}},N={__name:"DemoPaginationBasic",setup(_){const t=m(1);return(r,n)=>(g(),P(u,{modelValue:p(t),"onUpdate:modelValue":n[0]||(n[0]=a=>d(t)?t.value=a:null),length:5},null,8,["modelValue"]))}},R={ts:`<script lang="ts" setup>
