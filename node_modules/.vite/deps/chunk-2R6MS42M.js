...
function P2(t3, i4) {
  if (i4) {
    if (!C(i4, R2))
      Object.defineProperty(i4, R2, { value: t3 });
    else if (t3 !== i4[R2])
      throw new Error(`Trying to cast object to subject type ${t3} but previously it was casted to ${i4[R2]}`);
  }
  return i4;
}
var T = (t3) => {
...
var S2 = (t3) => "string" === typeof t3 ? t3 : B(t3);
function q3(t3) {
  if (C(t3, R2))
    return t3[R2];
...
function D(t3, i4) {
  if ("string" === typeof i4 && -1 !== t3.indexOf(i4))
    return i4;
  for (let e3 = 0; e3 < i4.length; e3++)
    if (-1 !== t3.indexOf(i4[e3]))
      return i4[e3];
  return null;
}
...
var tt = class {
  ...
  possibleRulesFor(t3, i4 = this.$) {
    ...
    if (i4 !== this.$)
      r2 = U2(r2, this.possibleRulesFor(t3, this.$));
    s3.rules = r2;
    s3.merged = true;
    return r2;
  }
...
var ft = (t3) => {
  let i4;
  return (e3) => {
    if ("undefined" === typeof i4)
      i4 = t3.every((t4) => -1 === t4.indexOf("*")) ? null : at(t3);
...
//# sourceMappingURL=chunk-2R6MS42M.js.map
